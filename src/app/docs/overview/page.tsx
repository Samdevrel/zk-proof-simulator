      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Interactive visualization of Zero-Knowledge proofs, helping developers understand how cryptographic proofs work.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Visual representation of prover-verifier interaction</li>
            <li>Step-by-step execution of ZK proof generation</li>
            <li>Interactive parameters configuration</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Interactive proof generation</li>
            <li>✓ Real-time verification visualization</li>
            <li>✓ Parameter exploration (circuit size, complexity)</li>
            <li>✓ Comparison of different ZK proof schemes</li>
            <li>✓ Educational walkthroughs</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Configure circuit parameters</li>
            <li>Run proof generation steps</li>
            <li>Watch verification process</li>
          </ol>
        </section>
